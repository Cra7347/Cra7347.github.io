...
text += 'newritpow \n'
text += 'newritual "Claim Guard Tower"   \n'
text += 'level 1 \n'
text += 'summoning  \n'
text += 'terr 20 \n'
text += 'rebatelvl 9 \n'
text += 'addstring "Quartermaster"  \n'
text += 'cost 0 40 \n'
text += 'free \n'
text += ' \n'

text += 'newritual "Claim Watch Tower"   \n'
text += 'level 1 \n'
text += 'summoning  \n'
text += 'terr 72 \n'
text += 'rebatelvl 9 \n'
...
text += 'newritual "Claim Major Settlement"   \n'
text += 'level 1 \n'
text += 'summoning  \n'
text += 'terr -28 \n'
text += 'rebatelvl 9 \n'
text += 'addstring "Marshall"  \n'
text += 'cost 0 70 \n'
text += 'free \n'
text += ' \n'

text += 'newritual "Claim Castle"   \n'
text += 'level 1 \n'
text += 'summoning  \n'
text += 'terr 22 \n'
text += 'rebatelvl 9 \n'
text += 'addstring "Vassal"  \n'
text += 'cost 0 100 \n'
text += 'free \n'
text += ' \n'

text += 'newmonster "Patrolman" \n'
text += 'name "Weak Soldier" \n'
text += 'descr "" \n'
text += 'copystats "Levy" \n'
text += 'copyspr "Levy" \n'
text += 'clearspec \n'
...
text += 'name "Weak Soldier" \n'
text += 'descr "" \n'
text += 'copystats "Slinger" \n'
text += 'copyspr "Slinger" \n'
text += 'clearspec \n'
text += 'rank -1 \n'
text += 'stupid \n'
text += 'money1 \n'
...
text += 'newmonster "Quartermaster" \n'
text += 'name "Quartermaster" \n'
text += 'descr "" \n'
text += 'copystats "Old Weapon Master" \n'
text += 'copyspr "Old Weapon Master" \n'
text += 'clearspec \n'
text += 'rank -1 \n'
text += 'immobile \n'
text += 'stationary \n'
...
text += 'newmonster "Regular" \n'
text += 'name "Regular" \n'
text += 'descr "" \n'
text += 'copystats "Spearman" \n'
text += 'copyspr "Spearman" \n'
text += 'stupid \n'
text += 'money1 \n'
text += 'allitemslots \n'
text += ' \n'
...
text += 'name "Regular" \n'
text += 'descr "" \n'
text += 'copystats "Light Cavalry" \n'
text += 'copyspr "Light Cavalry" \n'
text += 'stupid \n'
text += 'money1 \n'
text += 'allitemslots \n'
text += ' \n'

text += 'newmonster "Marshall" \n'
text += 'name "Marshall" \n'
text += 'descr "" \n'
text += 'copystats "Light Cavalry" \n'
text += 'copyspr "Light Cavalry" \n'
...
text += 'newmonster "Heavy Patrol" \n'
text += 'name "Heavy Patrol" \n'
text += 'descr "" \n'
text += 'copystats "Halberdier" \n'
text += 'copyspr "Halberdier" \n'
text += 'stupid \n'
text += 'money1 \n'
text += 'allitemslots \n'
text += ' \n'
...
text += 'newmonster "Vassal" \n'
text += 'name "Vassal" \n'
text += 'descr "" \n'
text += 'copystats "High Lord" \n'
text += 'copyspr "High Lord" \n'
text += 'clearspec \n'
text += 'rank -1 \n'
text += 'immobile \n'
text += 'stationary \n'
...
text += 'newmonster "Sylveon"  \n'
text += 'descr "Time for a diapy change!"  \n'
text += 'copystats "Ogre"  \n'
text += 'hp 28 \n'
text += 'mr 8 \n'
text += 'str 6 \n'
text += 'mor 10 \n'
text += 'spr1 "Randomclass/mommy3.tga"  \n'
text += 'spr2 "Randomclass/mommy4.tga"  \n'
text += 'clearweapons  \n'
text += 'rangedweaponbonus 1 "Charm"  \n'
text += 'rangedweaponbonus 3 "Moonlight"  \n'
text += 'clearspec \n'
text += 'power 0 1  \n'
text += 'charmres \n'
text += 'battlefast \n'
